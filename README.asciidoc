[NOTE]
==== Please note, this is only a fork of `shrinkwrap/resolver`, which solely affects the `maven/impl-maven` project. Please consult the README.md in that subfolder for details. ====
